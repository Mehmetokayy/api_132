...
@Test
 public void get12(){
    ...
    response.
        ...
        //1.Way: I will get all genders in a list then calculate the number of females
        JsonPath jsonPath= response.jsonPath();
       List<String> allGenders = jsonPath.getList("data.gender");
    System.out.println("allGenders = " + allGenders); //allGenders = [female, female, male, female, male, female, male, male, male, male]
    ...
    System.out.println("numberOfFemale = " + numberOfFemales);
    ...
    assertTrue(numberOfFemales<=numberOfMaleUsers);
